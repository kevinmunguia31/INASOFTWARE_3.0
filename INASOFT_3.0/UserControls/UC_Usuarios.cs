...
namespace INASOFT_3._0.UserControls
{
    public partial class UC_Usuarios : UserControl
    {
        ...
        {
            string sql = "select usuarios.id, usuarios.nombre, usuarios.usuario, usuarios.password, tipo_usuario.nombre as Rol from usuarios inner join tipo_usuario on usuarios.id_tipo = tipo_usuario.id";
            try
            {
        ...
        public void CargarCategoria()
        {
            ...
            cbRoles.Items.Clear();
            string sql = "SELECT id, nombre FROM tipo_usuario ORDER BY nombre ASC";
